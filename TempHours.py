...
my_email = 'anirudha.mulay@fortra.com'
tempo_token= 'oajd7sz1T12mWVx6WimYO6DYqk2RF3-us'
jira_token= 'ATATT3xFfGF0Y4JFsJALmZ3ocpAVN3ARvpw33-KDQL700YEP2ZtMw7D4cPkDFAng_P2WR7pah_ATxo_aNpKm8QorCrdWgjfAk7D4be1LiiRk2ARt@Z@ypCs'


##CONSTANTS##
TEMPO_BASEURL= 'https://api.tempo.io/4'
JIRA_BASEURL = 'https://helpsystems.atlassian.net/rest/api/3'
...
def get_cell_value(df, column_name, row_index);
    if column_name in df.columns and <= row_index < len (df):
